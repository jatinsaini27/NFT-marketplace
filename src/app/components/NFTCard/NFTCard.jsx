...
const NFTCard = () => {
    ...
    const CardArray = [
        images.nft_image_1, images.nft_image_2, images.nft_image_3, images.nft_image_1, images.nft_image_2, images.nft_image_3, images.nft_image_1, images.nft_image_2, images.nft_image_3
    ]
        ...
        <div className={Style.NFTCard_box} key={i+1}>
            ...
            <div className={Style.NFTCard_box_update_details}>
                ...
                <div className={Style.NFTCard_box_update_details_category}>
                    <BsImages className={Style.gallery_icon}/>
                </div>
            </div>
        </div>
      ))}
